...
# Nota: Assicurati che inizi esattamente con <svg e finisca con </svg>
html_partitore = f"""
<div style="display: flex; justify-content: center; background-color: white; padding: 20px; border-radius: 10px;">
    <svg width="300" height="250" viewBox="0 0 300 250" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="100" y="75" font-family="Arial" font-weight="bold">R1</text>
        <text x="180" y="75" font-family="Arial" font-size="14" fill="#555">{ita(r1, 0)} Ω</text>

        <rect x="135" y="130" width="30" height="60" fill="white" stroke="black" stroke-width="2"/>
        <text x="100" y="165" font-family="Arial" font-weight="bold">R2</text>
        <text x="180" y="165" font-family="Arial" font-size="14" fill="#555">{ita(r2, 0)} Ω</text>

        <text x="135" y="25" font-family="Arial" font-weight="bold" fill="blue" text-anchor="middle">Vin: {ita(vin, 1)}V</text>
        <circle cx="225" cy="115" r="5" fill="red"/>
